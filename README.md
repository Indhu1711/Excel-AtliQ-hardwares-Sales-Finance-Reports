...
The top 2 customers account for **~26% of India's total revenue**. A large portion of India’s revenue comes from a few customers, which creates risk if any of them reduce orders.
